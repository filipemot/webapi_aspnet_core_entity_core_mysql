...
namespace Api_Produtos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<Data.AppDbContext>(options => options.UseMySql(mysqlConnection, Microsoft.EntityFrameworkCore.ServerVersion.AutoDetect(mysqlConnection)));
